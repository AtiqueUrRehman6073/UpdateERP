            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Issue Return(Received Back from Production)', icon: 'fa fa-fw fa-wrench', routerLink: ['/utils'] },
                    {
                        ...
                        items: [
                            { label: 'Stock Ledger Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockledgerreport'] },
                            { label: 'Stock Movement Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockmovementreport'] },
                            { label: 'Stock Ledger', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockledger'] },
                            { label: 'Stock Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockreport'] },
                            { label: 'Stock Report(Base Unit)', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockreportbaseunit'] },
                            { label: 'Stock Movement', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockmovement'] },
                            { label: 'Stock Adjustment Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockadjustmentreport'] },
                            { label: 'Reorder Level Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/recorderlevelreport'] },
                            { label: 'BOM Status', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/bomstatus'] },
                            { label: 'Issue Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/issuereport'] },
                            { label: 'Invoice Profit Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/invoiceprofitreport'] },
                            { label: 'Stock Ageing Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/stockageingreport'] },
                            { label: 'Item Wise Profit Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['/storewarehouse/itemwiseprofitreport'] }
                        ]
                    },
                    { label: 'Damage Entry', icon: 'fa fa-fw fa-wrench', routerLink: ['/damageentry'] },
                ...
                items: [
                    ...
                    { label: 'Customer Enquiry', icon: 'fa fa-fw fa-wrench', routerLink: ['/utils'] },
                    {
                        ...
                        items: [
                            ...
                            { label: 'Sales Report', icon: 'fa fa-fw fa-sign-in', routerLink: ['sale/salesvoucher'] },
