...
let StorewarehouseRoutingModule = class StorewarehouseRoutingModule {
};
StorewarehouseRoutingModule = __decorate([
    NgModule({
        imports: [RouterModule.forChild(routes)],
        exports: [RouterModule]
    })
], StorewarehouseRoutingModule);
export { StorewarehouseRoutingModule };
//# sourceMappingURL=storewarehouse-routing.module.js.map