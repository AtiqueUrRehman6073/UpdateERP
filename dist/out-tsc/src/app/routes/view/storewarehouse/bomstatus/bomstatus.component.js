...
let BOMStatusComponent = class BOMStatusComponent {
...
BOMStatusComponent = __decorate([
    Component({
        selector: 'app-bomstatus',
        templateUrl: './bomstatus.component.html',
        styleUrls: ['./bomstatus.component.scss']
    })
], BOMStatusComponent);
export { BOMStatusComponent };
//# sourceMappingURL=bomstatus.component.js.map